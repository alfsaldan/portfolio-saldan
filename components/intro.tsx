    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/images/SAVE_20241004_155920.jpg"
              alt="Alfi Saldan"
              width="192"
              height="192"
              quality="95"
      ...
      >
        <span className="font-bold">Alfi Fikri Putra Saldan.</span>
      </motion.h1>
      <motion.h4
      ...
      >
        <a
          ...
          href="https://id.linkedin.com/in/alfi-fikri-putra-saldan-516a00323"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:saldanputra46@gmail.com"
          target="_blank"
        >
          <RiMailSendLine />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/alfsaldan"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/alf_saldan/"
          target="_blank"
        >
          <BsInstagram />
        </a>
